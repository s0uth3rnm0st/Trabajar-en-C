...
{
    printf(" %d \t%s \t%d \t%d \t%d \t%d \t%d\n", laPelicula.anioEstreno,laPelicula.titulo,laPelicula.vistas,laPelicula.codigoPelicula,laPelicula.id,laPelicula.idActor,laPelicula.idGenero);
}
